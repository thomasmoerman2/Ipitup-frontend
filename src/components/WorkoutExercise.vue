<template>
    <button class="flex gap-3 items-center justify-between rounded-md p-3 h-max bg-black-10 box-border">
        <img :src="img" alt="image" class="w-[84px] h-[74px] rounded-md aspect-square ">
